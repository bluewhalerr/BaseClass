...
public class OBase {
	...
	public static String getValuesforMultiple(String sheetname, int rownum, int cellnum) throws Throwable {
	...
	public static String getValuesforMultiple1(String sheetname, int rownum, int cellnum) throws Throwable {
	...
	public static String getValuesexcel2(String sheetname, int rownum, int cellnum) throws Throwable {
